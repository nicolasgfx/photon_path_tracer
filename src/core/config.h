...
// ── Image output ────────────────────────────────────────────────────
constexpr int   DEFAULT_IMAGE_WIDTH        = 512;
constexpr int   DEFAULT_IMAGE_HEIGHT       = 512;
...
constexpr int   DEFAULT_NEE_LIGHT_SAMPLES  = 16;   // M: shadow-ray samples per hitpoint (1=fast, 4-16=soft)
...
constexpr int   DEBUG_PHOTON_STRIDE        = 50;    // render every Nth photon in debug PNG
constexpr int   DEBUG_OBJ_PHOTON_STRIDE    = 50;    // export every Nth photon to .obj file
